...
cat ./input/gtree_11tax_est_5genes_R1.tre ./input/ConsensusTrees/tree1.txt.raxml.consensustreemre | /usr/bin/env /usr/lib/jvm/java-17-openjdk-amd64/bin/java -XX:+ShowCodeDetailsInExceptionMessages -cp /home/abdur-rafi/.config/Code/User/workspaceStorage/da91ba3e148e5727246c82da7f9911d2/redhat.java/jdt_ws/E-WQFM_731a4073/bin src.Main > ./input/ewqfm-out.txt
# python ./output/getFpFn.py -t ./input/11_tax_true.txt -e ./input/ewqfm-out.txt
