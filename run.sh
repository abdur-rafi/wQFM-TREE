    ...
    then
        ...
        do
            ...
            then
                ...
                /usr/bin/env /usr/lib/jvm/java-17-openjdk-amd64/bin/java  -XX:+ShowCodeDetailsInExceptionMessages -cp /home/abdur-rafi/.config/Code/User/workspaceStorage/da91ba3e148e5727246c82da7f9911d2/redhat.java/jdt_ws/E-WQFM_731a4073/bin src.Main $1/$file/$file2/all_gt_cleaned.tre $1/$file/$file2/cons.tre $1/$file/$file2/ewqfm-out-cons-flat-div.txt
                python ./output/getFpFn.py -t $1/true_tree_trimmed -e $1/$file/$file2/ewqfm-out-cons-flat-div.txt > $1/$file/$file2/ewqfm-cons-flat-div-score.txt
                python ./output/getFpFn.py -t $1/true_tree_trimmed -e $1/$file/$file2/wQFM-v1.2-best.tre >> $1/$file/$file2/ewqfm-cons-flat-div-score.txt
